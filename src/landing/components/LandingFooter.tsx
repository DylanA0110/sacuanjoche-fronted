...
interface LandingFooterProps {
  onHashLink: (e: React.MouseEvent<HTMLAnchorElement>, hash: string) => void;
}

export function LandingFooter({ onHashLink }: LandingFooterProps) {
  return (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-sans text-xl sm:text-2xl font-black text-white">
                  Floristería <span className="text-white/90">Sacuanjoche</span>
                </h3>
              </div>
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
              <p className="text-gray-500 text-sm">
                © {new Date().getFullYear()} Floristería Sacuanjoche. Todos los
                derechos reservados.
              </p>
